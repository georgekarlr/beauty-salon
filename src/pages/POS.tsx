...
const POSPage: React.FC = () => {
    ...
    // Helper to check if payment is sufficient
    const isPaymentSufficient = (typeof amountTendered === 'number' ? amountTendered : 0) >= totalAmount
                    ...
                    <div className="flex gap-2">
                        ...
                        {step === 3 && (
                            <button
                                ...
                                // FIX APPLIED HERE: Added !isPaymentSufficient check
                                disabled={processing || selectedItems.length === 0 || !persona || !isPaymentSufficient}
